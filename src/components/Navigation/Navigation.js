...
function Navigation() {
  ...
  return (
    <>
      ...
      <button className="navigation-mobile" onClick={handleClick} type="button">
        <img
          className="navigation-mobile__btn"
          src={navBtn}
          alt="навигация"
        />
      </button>
      ...
      <div className={isPopapOpen ? 'popup popup_opened' : 'popup'}>
        <div className="popup-container">
          ...
          <button className="popup__btn-exit" onClick={handleClick} type="button" aria-label="выход" />
        </div>
      </div>
    </>
  );
